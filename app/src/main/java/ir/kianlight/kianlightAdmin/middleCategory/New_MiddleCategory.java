        ...
        send_cat_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (address.getString("is_edit", "nothing").equals("true")) {
                    ...
                    volley.connect(New_MiddleCategory.this, "category", "update", true, cat_id_edt.getText().toString(), pic_category, title_edt.getText().toString(), id);

                } else if (pic_reader.getString("Editable?", "nothing to show").equals("yes")) {
                    volley.connect(New_MiddleCategory.this, "category", "update", true, cat_id_edt.getText().toString(), pic_category, title_edt.getText().toString(), id);
                    //    Log.i("mohsenjamali", "onClick: 2");
                } else {
                    volley.connect(New_MiddleCategory.this, "category", "send", true, cat_id_edt.getText().toString(), pic_category, title_edt.getText().toString(), id);
