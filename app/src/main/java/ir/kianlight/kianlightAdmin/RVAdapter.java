    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        ...
        if (holder instanceof MyViewHolder) {
            ...
            if (Mode.equals("middle_category")) {
                myViewHolder.code.setText("کد دسته بندی میانی: " + changeNumber(IdItems.get(position)));
                    ...
                    delete_alert_yes.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            ...
                            if (Mode.equals("product")) {
                                ...
                                volley.connect(context, "category", "delete", false, "", "", "", IdItems.get(position));
                            } else if (Mode.equals("middle_category")) {
                                volley.connect(context, "category", "delete", true, "", "", "", IdItems.get(position));
