...
import ir.kianlight.kianlightAdmin.comment.CommentActivity;
import ir.kianlight.kianlightAdmin.customer.Customer;
import ir.kianlight.kianlightAdmin.history.HistoryActivity;
...
import ir.kianlight.kianlightAdmin.survay.SurvayActivity;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void onBtn3(View v) {
        Intent intent = new Intent(MainActivity.this, SurvayActivity.class);
        MainActivity.this.startActivity(intent);
    }
