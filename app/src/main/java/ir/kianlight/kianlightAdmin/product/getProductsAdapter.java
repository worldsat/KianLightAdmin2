...
public class getProductsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private List<String> ImageItems, IdItems, DescriptionItems, NameItems, SpecialItems, Price3Items, Image1Items, ColorItems, NumberBoxItems, CategoryItems;
    private List<String> DiscountItems, Image2Items, VotesItems,Price2Items,Price1Items,zarib_number_boxItems, Image3Items, Image4Items, Image5Items, Image6Items, OtherItems, AvaiableItems;
    ...
    public getProductsAdapter(final Context context, List<String> DiscountItems, List<String> IdItems, List<String> DescriptionItems, List<String> NameItems, List<String> Price3Items, List<String> Price2Items, List<String> Price1Items, List<String> ImageItems, List<String> Image1Items, List<String> Image2Items, List<String> VotesItems, List<String> Image3Items, List<String> Image4Items, List<String> Image5Items, List<String> Image6Items, List<String> OtherItems, List<String> ColorItems, List<String> NumberBoxItems,List<String>zarib_number_boxItems, List<String> CategoryItems, List<String> AvaiableItems, List<String> SpecialItems, RecyclerView recyclerViewlist) {

        this.DiscountItems = DiscountItems;
        this.IdItems = IdItems;
        this.DescriptionItems = DescriptionItems;
        this.NameItems = NameItems;
        this.Price3Items = Price3Items;
        this.Price2Items = Price2Items;
        this.Price1Items = Price1Items;
        ...
        this.NumberBoxItems = NumberBoxItems;
        this.zarib_number_boxItems = zarib_number_boxItems;
...
//---------------------------
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        ...
        if (holder instanceof MyViewHolder) {
            ...
            myViewHolder.code.setText("کد دسته بندی میانی: " + changeNumber(CategoryItems.get(position)));
            ...
            final String link = "http://www.kianlight.ir/kianlight/" + ImageItems.get(position);
            ...
            myViewHolder.edit.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    try {
                        ...
                        intent.putExtra("price3", Price3Items.get(position));
                        intent.putExtra("price2", Price2Items.get(position));
                        intent.putExtra("price1", Price1Items.get(position));
                        ...
                        intent.putExtra("color", ColorItems.get(position));
                        intent.putExtra("number_box", NumberBoxItems.get(position));
                        intent.putExtra("zarib_number_box", zarib_number_boxItems.get(position));
                ...
                public void onClick(View v) {
                    ...
                    delete_alert_yes.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            ...
                            volley.connect(context, "product", "delete", false, "", "", "", IdItems.get(position));
