...
public class RVAdapterListName extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private List<String> NameItems, MobileItems, AddressItems, CityItems, TellItems, StateItems, CategoryItems,DateItems;
    ...
    public RVAdapterListName(final Context context, List<String> NameItems, List<String> MobileItems, List<String> AddressItems, List<String> IdItems, List<String> CityItems, List<String> StateItems, List<String> TellItems, List<String> CategoryItems,List<String>DateItems, RecyclerView recyclerViewlist) {
...
//----------taein noe holder ba tavajoh be viewtype
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        ...
        if (holder instanceof MyViewHolder) {
            ...
            myViewHolder.cat_customer.setText("درجه " + CategoryItems.get(position));
            ...
            final String cat = CategoryItems.get(position);
            // glide
...
*/
            ...
            myViewHolder.edit.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    //set Radio Value for Edit
                    switch (cat) {
                        case "1":
                            edit_alert_1.setChecked(true);
                            break;
                        case "2":
                            edit_alert_2.setChecked(true);
                            break;

                        case "3":
                            edit_alert_3.setChecked(true);
                            break;
...
// ma chondota layout toye recyclerview darim pad bayad vase dotash holder tarif konim
    ...
    private class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView name, edit, delete, address, mobile, tell, state, city, cat_customer,date;
        ...
        private MyViewHolder(View itemView) {
            ...
            cat_customer = itemView.findViewById(R.id.cat_customer);
