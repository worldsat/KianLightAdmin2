package ir.kianlight.kianlightAdmin.slider;
...
public class getSlider {
    ...
    public void get_banners(final Context context, final ImageView[] upload_image) {
        ...
        String urlJsonArray = "http://www.kianlight.ir/kianlight/getSlider.php";
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            for (int i = 0; i < array.length(); i++) {
                                ...
                                String link2 = "http://www.kianlight.ir/kianlight/slider/" + person.getString("Image");
