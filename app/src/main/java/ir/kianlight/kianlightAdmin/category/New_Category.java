    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back_icon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(New_Category.this, Category.class);
                New_Category.this.startActivity(intent);
            }
        });
        TextView title_toolbar = findViewById(R.id.title_toolbar_rtl);
        title_toolbar.setText("ایجاد دسته بندی جدید");
        //toolbar end
        ...
        if (pic_reader.getString("Editable?", "nothing to show").equals("yes")) {
            if (address.getString("is_edit", "nothing").equals("true")) {
                edit_ads();
                title_toolbar.setText("ویرایش دسته بندی");
        ...
        send_cat_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (address.getString("is_edit", "nothing").equals("true")) {
                    ...
                    volley.connect(New_Category.this, "category", "update",false, "", pic_category, title_edt.getText().toString(), id);

                } else if (pic_reader.getString("Editable?", "nothing to show").equals("yes")) {
                    volley.connect(New_Category.this, "category", "update", false,"", pic_category, title_edt.getText().toString(), id);
                    //    Log.i("mohsenjamali", "onClick: 2");
                } else {
                    volley.connect(New_Category.this, "category", "send",false, "", pic_category, title_edt.getText().toString(), id);
...
// Add all other intents
    ...
    public void onRequestPermissionsResult(int requestCode, String permissions[], int[] grantResults) {
        if (mCropImageUri != null && grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
            ...
            Intent intent = new Intent(New_Category.this, croping_image.class);
